...
enum class NvmeBufferType : uint8_t { BLOCK = 1, MANAGED_BUFFER = 2, TINY_BUFFER = 3 };

static constexpr idx_t NVME_BUFFER_TYPE_COUNT = 3;
...
public:
	...
	//! DIRECT_IO
	NvmeBuffer(NvmeBufferType type, uint64_t user_size);
...
public:
	...
	NvmeBufferType GetBufferType() const {
		return type;
	}
